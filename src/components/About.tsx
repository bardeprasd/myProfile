...
const About: React.FC = () => {
  ...
  return (
    <div style={{ paddingLeft: '250px' }}> {/* Add left padding */}
      ...
      >
        ...
        <Box textAlign="center" mt={2}> {/* Add margin-top for spacing */}
          ...
          <Typography variant="body1" paragraph style={{ color: '#cccccc' }}>
            Hello, I am Prasad Barde, a passionate Front End Developer driven by the passion to learn and implement new technologies. With experience in the IT industry, I possess a robust skill set that includes expertise in Java, Spring Framework, React.js, JavaScript, and MySQL.
          </Typography>
        </Box>
      </Grid>
